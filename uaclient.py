...
if __name__ == "__main__":
    ...
    try:
        ...
        print ("Usage: si el metodo es REGISTER el ultimo argumento tiene que ser un entero")
        raise SystemExit
    ...
    if METODO == "REGISTER":
        ...
        try:
            ...
            Sin_servidor = " Error: No server listening at " + REGPROXY_IP + " port " + str(REGPROXY_PTO)
            print Sin_servidor
